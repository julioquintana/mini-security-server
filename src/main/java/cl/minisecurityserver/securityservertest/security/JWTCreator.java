...
/**
 * The JWTCreator class holds the sign method to generate a complete JWT (with Signature) from a
 * given Header and Payload content.
 */
...
public final class JWTCreator {
  ...
  public JWTCreator(
      Algorithm algorithm, Map<String, Object> headerClaims, Map<String, Object> payloadClaims)
  ...
  public static class Builder {
     ...
     * @throws IllegalArgumentException if the name is null.
     */
    public Builder withArrayClaim(String name, List<String> items) throws IllegalArgumentException {
      assertNonNull(name);
      addClaim(name, items);
      return this;
    }
     ...
     * @throws JWTCreationException if the claims could not be converted to a valid JSON or there
     *     was a problem with the signing key.
     */
